  ...
  const renderEducationFields = (education, index) => {
    ...
    if (education.qualification || education.degree || education.education) {
      fields.push({
        ...
        label: "Qualification",
        value:
          education.qualification || education.degree || education.education,
      });
    }
    ...
    if (education.passingYear || education.year_of_passing || education.year) {
      fields.push({
        ...
        label: "Passing Year",
        value:
          education.passingYear || education.year_of_passing || education.year,
      });
    }
  ...
  const jobCards = [
    {
      icon: Briefcase,
      label: "Employee ID",
      value: profile.id || profile.employee_id,
      color: "bg-indigo-500",
    },
    {
      icon: Building2,
    ...
    },
    {
      icon: Clock,
      label: "Shift",
      value: profile.employeeShift || profile.shift,
      color: "bg-orange-500",
    },
    {
      icon: CalendarDays,
            ...
            <div className="bg-white rounded-2xl shadow-md p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {infoCards.map((card, idx) => (
                  <div
                    key={idx}
                    className="group bg-gray-50 rounded-xl p-4 border border-gray-100 hover:shadow-md transition-all"
                  >
              ...
              {educationArray.length > 0 ? (
                <div className="space-y-6">
                  {educationArray.map((education, index) => {
                    const educationFields = renderEducationFields(
                      education,
                      index,
                    );
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-800">
                        {profile.permanentZipCode ||
                          profile.permanent_zipcode ||
                          "Not provided"}
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-800">
                        {profile.presentZipCode ||
                          profile.present_zipcode ||
                          "Not provided"}
                      </p>
                    </div>
                  </div>
