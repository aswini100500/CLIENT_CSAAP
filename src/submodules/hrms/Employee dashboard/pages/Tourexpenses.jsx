  ...
  const fetchTours = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE}/api/tours?user_id=${user.company_id}`,
      );
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
            <div>
              ...
              <p className="text-gray-600">
                Manage your tour applications and expenses
              </p>
            </div>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900 font-medium">
                            {new Date(tour.from_date).toLocaleDateString(
                              "en-US",
                              {
                                day: "numeric",
                                month: "short",
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900 font-medium">
                            {new Date(tour.to_date).toLocaleDateString(
                              "en-US",
                              {
                                day: "numeric",
                                month: "short",
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-gray-600 ml-11">
                Fill in the details below to create a new tour application
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("tourTo", e.target.value)
                    }
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("expensesDate", e.target.value)
                    }
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  />
                </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Add individual expense items for this tour
                  </p>
                </div>
                <button
                          ...
                          <td className="px-6 py-4">
                            <label className="flex items-center gap-2 text-sm text-blue-600 cursor-pointer hover:text-blue-800">
                              ...
                              <input
                                ...
                                className="hidden"
                                onChange={(e) =>
                                  handleExpenseFileChange(expense.id, e)
                                }
                                accept=".pdf,.jpg,.jpeg,.png"
                              />
                            </label>
              ...
              {expenses.length === 0 && (
                <div className="text-center py-12 border-2 border-dashed border-gray-300 rounded-xl bg-gray-50">
                  ...
                  <div className="text-sm text-gray-400">
                    Click "Add Expense Item" to get started
                  </div>
                </div>
              )}
            </div>
