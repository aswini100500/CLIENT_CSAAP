...
export default function MonthlySalaryProcess() {
  ...
  const designations = ["DEMO", "Manager", "Developer", "Analyst", "Executive", "Trainee"];
  const employees = [
    "John Smith", "Sarah Johnson", "Mike Chen", "Emily Davis", 
    "Robert Wilson", "Lisa Brown", "David Miller", "Maria Garcia",
    "James Wilson", "Priya Sharma", "Alex Thompson", "Emma Roberts"
  ];
      ...
      <div className="bg-white shadow-lg p-6 mt-4 rounded-lg">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          ...
          <div className="flex items-center gap-2">
            <label className="text-gray-700 font-medium whitespace-nowrap">For Month</label>
            <input
              type="month"
          ...
          <div className="space-y-2">
            ...
            <div className="border border-gray-300 rounded h-40 overflow-auto p-3 text-sm space-y-1">
              {employees.map((employee, index) => (
                <label key={index} className="flex items-center gap-2 p-1 hover:bg-gray-50 rounded cursor-pointer">
