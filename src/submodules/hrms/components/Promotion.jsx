          ...
          <div className="bg-white rounded-xl p-6 max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Promotion request for {selectedEmployee?.name} has been
                submitted successfully and sent for approval.
              </p>
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-500 mt-1">
                Promote employees to new positions with updated compensation
              </p>
            </div>
          </div>
                ...
                {employees.map((employee) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${getPerformanceColor(employee.performance)}`}
                      >
              ...
              {!selectedEmployee ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 mt-4">
                    Please select an employee to proceed with promotion.
                  </p>
                </div>
              ) : (
                    ...
                    <div>
                      ...
                      >
                        ...
                        {promotionPositions
                          .filter(
                            (pos) =>
                              pos.department === selectedEmployee.department,
                          )
                          .map((position) => (
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Employee should have consistent "Good" or better performance
                    ratings for the last 2 review cycles.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Minimum 1 year in current position, or exceptional
                    performance with 6+ months tenure.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Should demonstrate required skills for the new position
                    through projects or certifications.
                  </p>
                </div>
              </div>
            </div>
