          ...
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm text-gray-500">
                Selected:{" "}
                <span className="font-medium text-blue-600">{month}</span>
              </div>
            </div>
          </div>
                  ...
                  <div className="border border-gray-300 rounded-lg bg-white h-40 overflow-hidden flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto p-2">
                      {sec.items.map((item, i) => (
                        <label
                          key={i}
                          className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-blue-50 cursor-pointer group"
                        >
                          <input
                            type="checkbox"
                            className="text-blue-500 focus:ring-blue-500 rounded"
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <label
                  key={report.id}
                  className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 cursor-pointer transition-all duration-200"
                >
                  <input
                    type="radio"
                    name="reportType"
