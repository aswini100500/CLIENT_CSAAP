    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Manage employee allocations and roles for active projects.</p>
        </div>
        <button 
          onClick={() => openModal()} 
                ...
                {assignments.length > 0 ? assignments.map((assign) => (
                  <tr key={assign.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-4 text-gray-600">
                      {projects.find(p => p.id === assign.project_id)?.project_name || `Project ID: ${assign.project_id}`}
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4 flex justify-center space-x-3">
                      <button onClick={() => openModal(assign)} className="text-gray-400 hover:text-blue-600 transition-colors">
                        <Edit2 size={18} />
                      </button>
                      <button onClick={() => handleDelete(assign.id)} className="text-gray-400 hover:text-red-600 transition-colors">
                        <Trash2 size={18} />
                      </button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colSpan="4" className="p-8 text-center text-gray-500">No project assignments found.</td>
                  </tr>
                )}
              </tbody>
            </table>
