...
export default function AdminRoutes() {
  return (
    <Routes>
      ...
      <Route path="accept-employee" element={<AcceptedEmployees />} />
      <Route path="terminate-employee" element={<TerminateEmployeePage />} />
      <Route path="transfer" element={<TransferPage />} />
      <Route path="promotion" element={<DesignationDetailsInsidePage />} />
      <Route path="download-idcard" element={<IDCardMaker />} />
      <Route path="download-visitingcard" element={<VisitingCardMaker />} />
      <Route path="view-document" element={<ViewEmployeeDocuments />} />
      <Route path="termcondition" element={<ViewTermsConditions />} />

      <Route path="attendance2" element={<QRCodeGenerator />} />
      <Route path="attendanceuser" element={<EmployeeAttendance />} />
      <Route path="timewise-attendance" element={<TimewiseAttendance />} />
      <Route path="late-coming-report" element={<MonthlyLateComingReport />} />
      <Route path="early-going-report" element={<EarlyGoingReport />} />
      ...
      <Route path="add-applicant" element={<AddApplicant basePath="/hrms" />} />
      <Route path="view-application" element={<ViewJobApplication />} />
      <Route path="shortlisted-candidate" element={<ShortlistedCandidates />} />
      <Route path="selected-candidates" element={<SelectedCandidate />} />
      <Route path="interview-report" element={<RecruitmentProcess />} />
      <Route path="interview-detail" element={<RecruitmentTablePage />} />

      <Route path="formApplied" element={<FormsApplied basePath="/hrms" />} />

      <Route path="offer-letter" element={<OfferLetterManagement />} />
      <Route path="download-offerletter" element={<DownloadOfferLetter />} />
      ...
      <Route path="hrms/complaints" element={<ComplaintsManagement />} />
      <Route path="hrms/calendar" element={<CalendarTabs />} />
