    ...
    <Routes>
      <Route element={<EmployeeProtectedRoute />}>
        ...
        <Route element={<Layout />}>
          ...
          <Route
            element={
              <RoutePermissionGuard permission="hrms.self_service.dashboard" />
            }
          >
          ...
          <Route
            element={
              <RoutePermissionGuard permission="hrms.self_service.profile" />
            }
          >
          ...
          <Route
            element={
              <RoutePermissionGuard permission="hrms.self_service.work_report" />
            }
          >
          ...
          <Route
            element={
              <RoutePermissionGuard permission="hrms.self_service.message" />
            }
          >
          ...
          <Route
            element={
              <RoutePermissionGuard permission="hrms.self_service.complain" />
            }
          >
          ...
          <Route
            element={
              <RoutePermissionGuard permission="hrms.self_service.documents" />
            }
          >
          ...
          <Route
            element={
              <RoutePermissionGuard permission="hrms.self_service.calendar" />
            }
          >
          ...
          <Route
            element={
              <RoutePermissionGuard permission="hrms.self_service.service_request" />
            }
          >
          ...
          <Route
            element={
              <RoutePermissionGuard permission="hrms.self_service.tasks" />
            }
          >
          ...
          <Route
            element={<RoutePermissionGuard permission="hrms.attendance" />}
          >
          ...
          <Route>
            <Route
              path="hr/accounting/client/dashboard"
              element={<ClientDashboard />}
            />
          </Route>
          <Route>
            <Route
              path="hr/accounting/client/company"
              element={<ClientCompanyForm />}
            />
            <Route
              path="hr/accounting/client/groupCreation"
              element={<ClientGroupCreation />}
            />
            <Route
              path="hr/accounting/client/listOfGroups"
              element={<ClientListOfGroups />}
            />
          </Route>
          <Route>
            <Route
              path="hr/accounting/client/ledger"
              element={<ClientLedgerForm />}
            />
            <Route
              path="hr/accounting/client/ledger/:id"
              element={<ClientLedgerForm />}
            />
            <Route
              path="hr/accounting/client/listOfLedgers"
              element={<ClientListOfLedger />}
            />
          </Route>
          <Route>
            <Route
              path="hr/accounting/client/statutoryReports"
              element={<ClientStatutoryReports />}
            />
            <Route
              path="hr/accounting/client/trialBalance"
              element={<ClientTrialBalance />}
            />
            <Route
              path="hr/accounting/client/reports"
              element={<ClientReports />}
            />
            <Route
              path="hr/accounting/client/transactionSummary"
              element={<ClientTransactionSummery />}
            />
            <Route
              path="hr/accounting/client/gst-summary"
              element={<ClientGSTSummary />}
            />
          </Route>
          <Route>
            <Route
              path="hr/accounting/client/contravoucher"
              element={<ClientContraVoucher />}
            />
            <Route
              path="hr/accounting/client/contravoucher/:id"
              element={<ClientContraVoucher />}
            />
            <Route
              path="hr/accounting/client/listOfContraVoucher"
              element={<ClientListOFContraVoucher />}
            />
            <Route
              path="hr/accounting/client/paymentVoucher"
              element={<ClientPaymentVoucher />}
            />
            <Route
              path="hr/accounting/client/paymentVoucher/:id"
              element={<ClientPaymentVoucher />}
            />
            <Route
              path="hr/accounting/client/listOfPaymentVoucher"
              element={<ClientListOfPaymentVoucher />}
            />
            <Route
              path="hr/accounting/client/receptVoucher"
              element={<ClientReceiveVouchers />}
            />
            <Route
              path="hr/accounting/client/receptVoucher/:id"
              element={<ClientReceiveVouchers />}
            />
            <Route
              path="hr/accounting/client/listOfReciptVoucher"
              element={<ClientReceiveVouchersList />}
            />
            <Route
              path="hr/accounting/client/journalvoucher"
              element={<ClientJournalVoucher />}
            />
            <Route
              path="hr/accounting/client/journalvoucher/:id"
              element={<ClientJournalVoucher />}
            />
            <Route
              path="hr/accounting/client/listOfJournalVoucher"
              element={<ClientListOfJournalVoucher />}
            />
          </Route>
          <Route>
            <Route
              path="hr/accounting/client/salevoucher"
              element={<ClientSaleVoucher />}
            />
            <Route
              path="hr/accounting/client/salevoucher/:id"
              element={<ClientSaleVoucher />}
            />
            <Route
              path="hr/accounting/client/listOfSaleVoucher"
              element={<ClientListOfSaleVoucher />}
            />
            <Route
              path="hr/accounting/client/purchasevoucher"
              element={<ClientPurchaseVoucher />}
            />
            <Route
              path="hr/accounting/client/purchasevoucher/:id"
              element={<ClientPurchaseVoucher />}
            />
            <Route
              path="hr/accounting/client/listOfPurchaseVoucher"
              element={<ClientListOFPurchaseVoucher />}
            />
          </Route>
          <Route>
            <Route
              path="hr/accounting/client/debitNote"
              element={<ClientDebitNote />}
            />
            <Route
              path="hr/accounting/client/debitNote/:id"
              element={<ClientDebitNote />}
            />
            <Route
              path="hr/accounting/client/debitNotesList"
              element={<ClientDebitNoteList />}
            />
            <Route
              path="hr/accounting/client/creditNote"
              element={<ClientCreditNote />}
            />
            <Route
              path="hr/accounting/client/creditNote/:id"
              element={<ClientCreditNote />}
            />
            <Route
              path="hr/accounting/client/creditNotesList"
              element={<ClientCreditNoteList />}
            />
          </Route>
          <Route>
            <Route
              path="hr/accounting/client/manfacturing"
              element={<ClientManufacturing />}
            />
            <Route
              path="hr/accounting/client/manfacturinglist"
              element={<ClientManufacturingList />}
            />
          </Route>
          <Route>
            <Route
              path="hr/accounting/client/bank-activities"
              element={<ClientBankActivites />}
            />
            <Route
              path="hr/accounting/client/cheque"
              element={<ClientCheque />}
            />
            <Route
              path="hr/accounting/client/cheque-register"
              element={<ClientChequeRegister />}
            />
          </Route>
          <Route>
            <Route
              path="hr/accounting/client/dayBook"
              element={<ClientDayBook />}
            />
          </Route>
          <Route>
            <Route
              path="hr/accounting/client/stockItemCreation"
              element={<ClientStockItemCreation />}
            />
            <Route
              path="hr/accounting/client/stockGroupSummery"
              element={<ClientStockGroupSummary />}
            />
          </Route>

          <Route element={<RoutePermissionGuard permission="crm.upload" />}>
            <Route path="crm/csv-upload-tab" element={<SimpleCSVUpload />} />
          </Route>
          ...
          <Route element={<RoutePermissionGuard permission="crm.payment" />}>
            <Route
              path="crm/payment"
              element={<ComingSoon title="Payment" />}
            />
          </Route>
          <Route
