    ...
    >
      {showToast && (
        <div className="fixed top-20 right-8 z-50 transform transition-all duration-300 flex items-center gap-3 bg-white border border-(--border-strong) shadow-(--shadow-float) px-4 py-3 rounded-xl animate-in fade-in slide-in-from-top-4">
          ...
          <div>
            <p className="text-[13px] font-bold text-(--text-strong) leading-tight">
              {toastMessage}
            </p>
            <p className="text-[10px] text-(--brand) font-bold uppercase tracking-widest mt-0.5">
        ...
        <div className="app-panel overflow-hidden">
          <div className="app-section-bar px-4 py-3 flex items-center justify-between">
            <h3 className="app-heading">
              All Brokers ({isLoading ? "..." : brokers.length})
            </h3>
          </div>
          ...
          {isLoading ? (
            <div className="px-4 py-20 text-center">
              ...
              <p className="text-[12px] text-(--text-soft) font-bold uppercase tracking-widest">
                Fetching Data...
              </p>
            </div>
          ) : brokers.length === 0 ? (
            <div className="px-4 py-12 text-center">
              ...
              <p className="text-[12px] mt-1 text-(--text-soft)">
                {searchTerm
                  ...
                  : "Get started by onboarding your first broker partner."}
              </p>
              <button
                onClick={() =>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col">
                <div className="p-5 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      <label className="modal-label">
                        Joined Date <span className="text-rose-500">*</span>
                      </label>
                      <input
                        name="joined_date"
