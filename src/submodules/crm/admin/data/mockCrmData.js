...
const INITIAL_BROKERS = [
  {
    ...
    email: "deals@apexrealty.com",
    phone: "+91 9899123456",
    commission: "2.0%",
  },
  {
    id: 2,
    name: "Sterling Realty Advisors",
    email: "contact@sterlingre.in",
    phone: "+91 9811002233",
    commission: "1.5%",
  },
  {
...
const INITIAL_STAFF = [
  {
    id: 1,
    name: "Amit Sharma",
    email: "amit.sharma@buildererp.com",
    role: "Sales Manager",
    department: "Sales",
    phone: "+91 9876501234",
  },
  {
    id: 2,
    name: "Priya Singh",
    email: "priya.singh@buildererp.com",
  ...
  },
  {
    id: 3,
    name: "Rahul Varma",
    email: "rahul.varma@buildererp.com",
...
const INITIAL_CUSTOMERS = [
  {
    ...
    description:
      "Leading IT services company. Booked a 3BHK flat at Grand Heights.",
    projectId: 1,
    ...
    projectStages: [
      {
        ...
        progress: 100,
        status: "completed",
        description: "Land acquisition and title deed clearance",
        budget: "1700000",
        paymentPercentage: "20.00",
        paymentSteps: [
          {
            id: 11,
            description: "Token Advance Booking",
            amount: "500000.00",
            percentage: "5.88",
            date: "2026-01-15",
          },
          {
            id: 12,
            description: "Allotment Letter signing",
            amount: "1200000.00",
            percentage: "14.12",
            date: "2026-01-20",
          },
      ...
      },
      {
        ...
        progress: 100,
        status: "completed",
        description: "Architectural drawings and structural safety approvals",
        budget: "850000",
        paymentPercentage: "10.00",
        paymentSteps: [
          {
            id: 21,
            description: "Architectural Layout Approval",
            amount: "850000.00",
            percentage: "10.00",
            date: "2026-02-28",
          },
      ...
      },
      {
        ...
        progress: 75,
        status: "in-progress",
        description: "Site excavation and concrete reinforcement foundation",
        budget: "2125000",
        paymentPercentage: "25.00",
        paymentSteps: [
          {
            id: 31,
            description: "Plinth Level Completion",
            amount: "2125000.00",
            percentage: "25.00",
            date: "2026-04-10",
          },
      ...
      },
      {
        ...
        progress: 0,
        status: "pending",
        description: "RCC brickwork framing and slab casting",
        budget: "2550000",
        paymentPercentage: "30.00",
        paymentSteps: [
          {
            id: 41,
            description: "Slab Casting Floor 1",
            amount: "1275000.00",
            percentage: "15.00",
            date: "",
          },
          {
            id: 42,
            description: "Slab Casting Floor 2",
            amount: "1275000.00",
            percentage: "15.00",
            date: "",
          },
      ...
      },
      {
        ...
        status: "pending",
        description:
          "Plumbing, electrical wiring, tiles and interior paintwork",
        budget: "850000",
        paymentPercentage: "10.00",
        paymentSteps: [
          {
            id: 51,
            description: "Plumbing & Tiling completion",
            amount: "850000.00",
            percentage: "10.00",
            date: "",
          },
      ...
      },
      {
        ...
        progress: 0,
        status: "pending",
        description: "Final registration, NOC certificates, and handing keys",
        budget: "425000",
        paymentPercentage: "5.00",
        paymentSteps: [
          {
            id: 61,
            description: "Key Handover and Registration",
            amount: "425000.00",
            percentage: "5.00",
            date: "",
          },
  ...
  },
  {
    ...
    annualRevenue: "",
    description:
      "Pediatric consultant. Booked a 3BHK Villa at Oasis Meadows. Discount applied.",
    projectId: 2,
    ...
    projectStages: [
      ...
      },
      {
        ...
        progress: 100,
        status: "completed",
        description: "Villa structural custom blueprints",
        budget: "1950000",
        paymentPercentage: "10.00",
        paymentSteps: [
          {
            id: 103,
            description: "Custom Design approval",
            amount: "1950000.00",
            percentage: "10.00",
            date: "2026-04-20",
          },
      ...
      },
      {
        ...
        progress: 40,
        status: "in-progress",
        description: "Deep pile foundation",
        budget: "4875000",
        paymentPercentage: "25.00",
        paymentSteps: [
          {
            id: 104,
            description: "Foundation cast",
            amount: "4875000.00",
            percentage: "25.00",
            date: "2026-05-15",
          },
      ...
      },
      {
        ...
        progress: 0,
        status: "pending",
        description: "Villa double height frame construction",
        budget: "5850000",
        paymentPercentage: "30.00",
        paymentSteps: [],
      },
      {
        ...
        progress: 0,
        status: "pending",
        description: "Italian marble fittings & lighting layout",
        budget: "1950000",
        paymentPercentage: "10.00",
        paymentSteps: [],
      },
      {
        ...
        progress: 0,
        status: "pending",
        description: "Possession keys, landscaping & security integration",
        budget: "-525000",
        paymentPercentage: "-2.69",
        paymentSteps: [
          {
            id: 105,
            description: "Final Handover Payment (Discount Applied)",
            amount: "-525000.00",
            percentage: "-2.69",
            date: "",
          },
...
const INITIAL_INTERACTIONS = [
  {
    ...
    date: "2026-01-15",
    time: "11:30",
    subject: "Initial Site Tour & Unit Selection",
    outcome: "Positive",
    notes:
      "Rajesh visited the Grand Heights site. Extremely impressed with Tower A view. Discussed budget range.",
    assignedTo: "Amit Sharma",
    duration: "60",
    location: "Grand Heights Site Office",
    priority: "High",
    contactId: null,
    followUpDate: "2026-01-18",
    followUpNotes: "Draft flat booking quote.",
  },
  {
    id: 2,
    customerId: 1,
    ...
    date: "2026-01-18",
    time: "16:15",
    subject: "Quote Review and Token Booking negotiation",
    outcome: "Positive",
    notes:
      "Negotiated base rate. Agreed to original budget profile. Customer agreed to pay token advance of 5 Lakhs.",
    assignedTo: "Amit Sharma",
    duration: "15",
    location: "Virtual",
    priority: "High",
    ...
    followUpNotes: "Execute Booking documents.",
  },
  {
    id: 3,
    customerId: 1,
    ...
    date: "2026-04-12",
    time: "10:00",
    subject: "Plinth Level Completion Certificate Shared",
    outcome: "Neutral",
    notes:
      "Shared formal invoice for plinth completion payment milestone (25% total value).",
  ...
  },
  {
    ...
    date: "2026-03-05",
    time: "14:00",
    subject: "Pricing Negotiation & Booking Agreement",
    outcome: "Positive",
    notes:
      "Negotiations concluded with a final price of ₹1.80 Cr (₹15 Lakhs discount). Booking token accepted.",
    assignedTo: "Priya Singh",
    duration: "90",
    location: "Builder ERP HQ Boardroom",
    priority: "High",
    contactId: null,
    followUpDate: "2026-03-10",
    followUpNotes: "Share architectural drawings.",
  },
];
...
const INITIAL_DOCUMENTS = [
  {
    ...
    type: "Agreement",
    fileName: "Allotment_Rajesh_Kumar_A102.pdf",
    fileSize: 245000,
    category: "Contract",
    tags: ["signed", "booking"],
  ...
  },
  {
    id: 2,
    customerId: 1,
    title: "Pan Card & Aadhaar Verification",
    type: "KYC Document",
    fileName: "Rajesh_Kumar_KYC.pdf",
    fileSize: 1800000,
    category: "KYC",
    tags: ["verified"],
    uploadedBy: "Amit Sharma",
  ...
  },
  {
    id: 3,
    customerId: 2,
    title: "Oasis Meadows Purchase Agreement",
    type: "Agreement",
    fileName: "OasisMeadows_Villa102_Kavita.pdf",
    fileSize: 320000,
    category: "Contract",
    tags: ["executed", "stamped"],
...
const INITIAL_PAYMENTS = [
  {
    ...
    transactionId: "CHQ-891024",
    description: "Booking Advance Token Payment",
    projectId: 1,
    projectName: "Grand Heights",
    bankName: "HDFC Bank",
    checkNumber: "891024",
  ...
  },
  {
    ...
    transactionId: "TXN-902182012",
    description: "Allotment Letter Booking Balance Stage 1",
    projectId: 1,
    projectName: "Grand Heights",
  ...
  },
  {
    ...
    paymentMethod: "Bank Transfer",
    transactionId: "",
    description: "Plinth Level Completion Stage 3 Demand Invoice",
    projectId: 1,
    projectName: "Grand Heights",
    receivedFrom: "",
    receivedBy: "Rahul Varma",
  },
  {
    id: 4,
    customerId: 2,
    ...
    status: "Paid",
    paymentMethod: "Bank Transfer",
    transactionId: "NEFT-782019",
    description: "Initial Booking Token Advance",
    projectId: 2,
    projectName: "Oasis Meadows",
    receivedFrom: "Kavita Mehta",
  ...
  },
  {
    ...
    status: "Paid",
    paymentMethod: "Cheque",
    transactionId: "CHQ-718290",
    description: "Allotment confirmation - Oasis Meadows Stage 1",
    projectId: 2,
    projectName: "Oasis Meadows",
    bankName: "ICICI Bank",
    checkNumber: "718290",
...
const INITIAL_TRANSACTIONS = [
  {
    ...
    remark: "Token Advance Booking Amount - Recvd.",
    accountNo: "HDFC A/C ***2012",
    debitAmount: 0,
    creditAmount: 500000,
    balance: 500000,
  },
  {
    ...
    transactionType: "Payment",
    remark: "Allotment Letter signing payment - Recvd.",
    accountNo: "HDFC A/C ***2012",
    debitAmount: 0,
  ...
  },
  {
    ...
    remark: "Demand Raised: Plinth Level Milestone Stage 3",
  ...
  },
  {
    ...
    transactionType: "Payment",
    remark: "Initial Booking Token Advance - Recvd.",
    accountNo: "ICICI A/C ***0819",
    debitAmount: 0,
  ...
  },
  {
    ...
    transactionType: "Payment",
    remark: "Allotment confirmation - Recvd.",
    accountNo: "ICICI A/C ***0819",
    debitAmount: 0,
    creditAmount: 2900000,
    balance: 3900000,
  },
];
...
export const mockCrmData = {
  ...
  addCustomer: async (customerData) => {
    ...
    const selectedBlock = selectedProject?.blocks?.find(
      (b) => b.id === blockId,
    );
    ...
    const newCustomer = {
      ...
      originalPrice: selectedUnit
        ? selectedUnit.price
        : parseFloat(customerData.totalValue) || 0,
  ...
  updateCustomer: async (id, updatedData) => {
    ...
    if (oldUnitId !== newUnitId) {
      ...
      const targetProj = projects.find(
        (p) => p.id === parseInt(updatedData.projectId),
      );
    ...
    const selectedUnit = selectedProject?.units?.find(
      (u) => u.id === newUnitId,
    );
    ...
    const updatedCustomer = {
      ...
      brokerName: selectedBroker ? selectedBroker.name : "",
      totalValue:
        parseFloat(updatedData.totalValue) || originalCustomer.totalValue,
      originalPrice: selectedUnit
        ? selectedUnit.price
        : parseFloat(updatedData.originalPrice) ||
          originalCustomer.originalPrice,
      lastContact: new Date().toISOString().split("T")[0],
    };
  ...
  deleteCustomer: async (id) => {
    ...
    const payments = getStorageItem("payments", INITIAL_PAYMENTS).filter(
      (p) => p.customerId !== parseInt(id),
    );
    setStorageItem("payments", payments);

    const interactions = getStorageItem(
      "interactions",
      INITIAL_INTERACTIONS,
    ).filter((i) => i.customerId !== parseInt(id));
    setStorageItem("interactions", interactions);

    const documents = getStorageItem("documents", INITIAL_DOCUMENTS).filter(
      (d) => d.customerId !== parseInt(id),
    );
    setStorageItem("documents", documents);

    const transactions = getStorageItem(
      "transactions",
      INITIAL_TRANSACTIONS,
    ).filter((t) => t.customerId !== parseInt(id));
    setStorageItem("transactions", transactions);
  ...
  addInteraction: async (customerId, interactionData) => {
    ...
    const newId =
      interactions.length > 0
        ? Math.max(...interactions.map((i) => i.id)) + 1
        : 1;
  ...
  addPayment: async (customerId, paymentData) => {
    ...
    if (newPayment.status === "Paid") {
      ...
      const clientTransactions = transactions.filter(
        (t) => t.customerId === parseInt(customerId),
      );
      ...
      const newLedgerEntry = {
        ...
        remark:
          ...
          `Payment received: Invoice #${newPayment.invoiceNumber}`,
        accountNo:
          newPayment.paymentMethod === "Bank Transfer"
            ? "HDFC A/C ***2012"
            : newPayment.paymentMethod === "Cheque"
              ? `${newPayment.bankName} Chq #${newPayment.checkNumber}`
              : "Cash Drawer",
        debitAmount: 0,
  ...
  updatePaymentStatus: async (paymentId, status) => {
    ...
    if (payment) {
      ...
      if (oldStatus !== "Paid" && status === "Paid") {
        ...
        const clientTransactions = transactions.filter(
          (t) => t.customerId === payment.customerId,
        );
        const currentBalance =
          clientTransactions.length > 0
            ? clientTransactions[clientTransactions.length - 1].balance
