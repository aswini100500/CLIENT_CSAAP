...
import { Building2, FileText, Mail, MapPin, Phone, Hash, AlertCircle, CheckCircle2 } from "lucide-react";
    ...
    return (
      <div className="flex items-center justify-center min-h-[calc(100vh-100px)]">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-4 text-slate-500 font-medium">Syncing GST Details...</p>
        </div>
      </div>
    );
  }

  const inputClass = "mt-1 block w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-2.5 text-slate-800 focus:border-green-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-green-500/10 font-medium text-sm transition-all duration-200";

  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight">GST & Company Details</h1>
          <p className="text-slate-500 mt-1">Information synchronized securely from the central database</p>
        </div>
        ...
        <form onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
            <div className="bg-linear-to-r from-slate-800 to-slate-900 p-6">
              ...
              {isEditing ? (
                ...
                <>
                  <h2 className="text-2xl font-bold text-white mb-1">{companyDetails.company_name}</h2>
            ...
            <div className="p-6 space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div className="w-full">
                  <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-0.5">Admin Email</p>
                  <p className="text-slate-800 font-medium">{companyDetails.admin_email || "N/A"}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="w-full">
                  <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-0.5">Contact Phone</p>
                  {isEditing ? (
                    <input
                      type="text"
                      name="company_phone"
                    ...
                    <p className="text-slate-800 font-medium">{companyDetails.company_phone || "N/A"}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="w-full">
                  <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-0.5">Admin Phone</p>
                  {isEditing ? (
                    <input
                      type="text"
                      name="admin_phone"
                    ...
                    <p className="text-slate-800 font-medium">{companyDetails.admin_phone || "N/A"}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="w-full space-y-3">
                  <p className="text-xs font-medium text-slate-400 uppercase tracking-wider">Registered Address</p>
                  {isEditing ? (
                    <div className="grid grid-cols-1 gap-3">
                      <div>
                        <label className="text-[11px] font-semibold text-slate-400 uppercase">Street Address</label>
                        <input
                          type="text"
                          name="street_address"
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div className="col-span-2">
                          <label className="text-[11px] font-semibold text-slate-400 uppercase">City</label>
                          <input
                            type="text"
                            name="city"
                            value={editForm.city}
                        ...
                        <div>
                          <label className="text-[11px] font-semibold text-slate-400 uppercase">Zip</label>
                          <input
                            type="text"
                            name="zip_code"
                      ...
                      <div>
                        <label className="text-[11px] font-semibold text-slate-400 uppercase">State</label>
                        <input
                          type="text"
                          name="state"
                    ...
                    <p className="text-slate-800 font-medium leading-relaxed">
                      {companyDetails.street_address ? (
                        <>
                          {companyDetails.street_address}<br />
                          {companyDetails.city}, {companyDetails.state} {companyDetails.zip_code}
                        </>
                      ) : "N/A"}
                    </p>
                  )}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
            <div className="bg-linear-to-r from-green-600 to-emerald-600 p-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-1">Tax Information</h2>
            ...
            <div className="p-6 space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div className="w-full">
                  <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-0.5">GST Number</p>
                  {isEditing ? (
                    <input
                      type="text"
                      name="gst_number"
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {companyDetails.gst_number && (
                        <span className="px-2 py-0.5 bg-green-100 text-green-700 rounded text-xs font-semibold">Valid</span>
                      )}
                    </div>
                  )}
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="w-full">
                  <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-0.5">PAN Number</p>
                  {isEditing ? (
                    <input
                      type="text"
                      name="pan_number"
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="w-full">
                  <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-0.5">Company Reg. No</p>
                  {isEditing ? (
                    <input
                      type="text"
                    ...
                    <p className="text-slate-800 font-medium">{companyDetails.registration_number || "N/A"}</p>
                  )}
                </div>
              </div>
            </div>
