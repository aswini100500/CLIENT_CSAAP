...
const projectService = {
    ...
    getApartmentById: async (id) => {
        const response = await axiosInstance.get(`${API_URL}/api/tenant/apartment/${id}`);
        return response.data;
    },

    updateApartment: async (id, projectData) => {
        const response = await axiosInstance.put(`${API_URL}/api/tenant/apartment/${id}`, projectData);
        return response.data;
    },

    deleteApartment: async (id) => {
        const response = await axiosInstance.delete(`${API_URL}/api/tenant/apartment/${id}`);
        return response.data;
    },
    ...
    getAllCommercials: async () => {
        const response = await axiosInstance.get(`${API_URL}/api/tenant/commercial`);
        return response.data;
    },

    getCommercialById: async (id) => {
        const response = await axiosInstance.get(`${API_URL}/api/tenant/commercial/${id}`);
        return response.data;
    },

    updateCommercial: async (id, projectData) => {
        const response = await axiosInstance.put(`${API_URL}/api/tenant/commercial/${id}`, projectData);
        return response.data;
    },

    deleteCommercial: async (id) => {
        const response = await axiosInstance.delete(`${API_URL}/api/tenant/commercial/${id}`);
        return response.data;
    },
    ...
    getPlottingById: async (id) => {
        const response = await axiosInstance.get(`${API_URL}/api/tenant/plotting/${id}`);
        return response.data;
    },

    updatePlotting: async (id, projectData) => {
        const response = await axiosInstance.put(`${API_URL}/api/tenant/plotting/${id}`, projectData);
        return response.data;
    },

    deletePlotting: async (id) => {
        const response = await axiosInstance.delete(`${API_URL}/api/tenant/plotting/${id}`);
        return response.data;
    },
    ...
    getDuplexById: async (id) => {
        const response = await axiosInstance.get(`${API_URL}/api/tenant/duplex/${id}`);
        return response.data;
    },

    updateDuplex: async (id, projectData) => {
        const response = await axiosInstance.put(`${API_URL}/api/tenant/duplex/${id}`, projectData);
        return response.data;
    },

    deleteDuplex: async (id) => {
        const response = await axiosInstance.delete(`${API_URL}/api/tenant/duplex/${id}`);
        return response.data;
    },
    ...
    getTriplexById: async (id) => {
        const response = await axiosInstance.get(`${API_URL}/api/tenant/triplex/${id}`);
        return response.data;
    },

    updateTriplex: async (id, projectData) => {
        const response = await axiosInstance.put(`${API_URL}/api/tenant/triplex/${id}`, projectData);
        return response.data;
    },

    deleteTriplex: async (id) => {
        const response = await axiosInstance.delete(`${API_URL}/api/tenant/triplex/${id}`);
        return response.data;
    },
};
