          ...
          <div className="bg-white rounded-xl shadow-xl border border-slate-200 w-full max-w-lg overflow-hidden flex flex-col transform transition-all duration-300 scale-100">
            ...
            <div className="flex justify-between items-center px-6 py-4 border-b border-slate-100 bg-slate-50/50">
              <div>
                ...
                <p className="text-xs text-slate-450 mt-0.5">Supplier ID: #{selectedSupplierForView.id}</p>
              </div>
              <button
                onClick={() => {
            ...
            <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
              ...
              <div className="flex justify-between items-start pb-4 border-b border-slate-100">
                <div>
                  ...
                  {selectedSupplierForView.contact_person && (
                    <p className="text-sm text-slate-500 mt-1">
                      Contact Person: <span className="font-semibold text-slate-700">{selectedSupplierForView.contact_person}</span>
                    </p>
                  )}
                </div>
                <span className={`px-2.5 py-1 rounded-full text-xs font-semibold ${
                  ...
                  {selectedSupplierForView.is_active === 1 ? 'Active' : 'Inactive'}
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 text-sm">
                ...
                <div>
                  <span className="block text-xs font-medium text-slate-400 uppercase tracking-wider">Email Address</span>
                  {selectedSupplierForView.email ? (
                    <a href={`mailto:${selectedSupplierForView.email}`} className="block text-slate-700 hover:text-blue-600 font-medium mt-1 transition-colors">
                      {selectedSupplierForView.email}
                    </a>
                  ) : (
                ...
                <div>
                  <span className="block text-xs font-medium text-slate-400 uppercase tracking-wider">Primary Phone</span>
                  {selectedSupplierForView.phone ? (
                    <a href={`tel:${selectedSupplierForView.phone}`} className="block text-slate-700 hover:text-blue-600 font-medium mt-1 transition-colors">
                      {selectedSupplierForView.phone}
                    </a>
                  ) : (
                    <span className="block text-slate-400 mt-1">—</span>
                ...
                <div>
                  <span className="block text-xs font-medium text-slate-400 uppercase tracking-wider">Alternate Phone</span>
                  {selectedSupplierForView.alternate_phone ? (
                    <a href={`tel:${selectedSupplierForView.alternate_phone}`} className="block text-slate-700 hover:text-blue-600 font-medium mt-1 transition-colors">
                      {selectedSupplierForView.alternate_phone}
                    </a>
                  ) : (
                    <span className="block text-slate-400 mt-1">—</span>
                ...
                <div className="sm:col-span-2">
                  <span className="block text-xs font-medium text-slate-400 uppercase tracking-wider">Address / Location</span>
              ...
              <div className="pt-4 border-t border-slate-100 flex justify-between text-[11px] text-slate-400">
                ...
                {selectedSupplierForView.updated_at && (
                  <span>Last Updated: {formatDate(selectedSupplierForView.updated_at)}</span>
                )}
              </div>
            </div>
