      ...
      try {
        ...
        items.forEach((item) => {
          const rawApprovals =
            ...
            item.approvalStatus;
          if (rawApprovals) {
            const checks = Array.isArray(rawApprovals)
              ? rawApprovals
              : [rawApprovals];
          ...
          if (rawPending) {
            const checks = Array.isArray(rawPending)
              ? rawPending
              : [rawPending];
            checks.forEach((record, index) =>
              pendingRecords.push(normalizePendingEntry(record, index)),
    ...
    const updatedItems = items.map((item) => {
      if (item.id === id) {
        ...
        if (field === "orderQty" || field === "orderRate") {
          updatedItem.orderAmount =
            updatedItem.orderQty * updatedItem.orderRate;
        }
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-3">
            ...
            {activeTab === "Main Info" && <Bill />}
            {activeTab === "Attachment" && <AttachmentPage />}
            {activeTab === "Item Info" && <div></div>}
              ...
              activeTab !== "Item Info" && (
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500 max-w-md mx-auto">
                    The {activeTab.toLowerCase()} section is currently being
