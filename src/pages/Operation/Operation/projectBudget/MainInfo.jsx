...
//   // Land Areas: entries with landAreaCost, landDevelopmentCost, approvalCost
...
//   // Add construction area at specific position
...
//   // Add saleable area at specific position
...
//   // Profit ratio as percentage of total construction budget (zero if construction budget is zero)
//   const profitRatio = totalConstructionBudget
//     ? (profit / totalConstructionBudget) * 100
//     : 0;
//   // total for newly added Land Areas section
...
//     doc.setFontSize(12);
//     doc.text(`Project: ${formData.selectedBudget}`, 14, 30);
//     doc.text(`Document Subject: ${formData.documentSubject}`, 14, 37);
//     doc.text(`Document Date: ${formData.documentDate}`, 14, 44);
...
const MainInfo = () => {
  ...
  //       const allProjects = [
  //         ...apartments.map(project => ({ ...project, type: 'Apartment' })),
  //         ...commercials.map(project => ({ ...project, type: 'Commercial' })),
  //         ...plottings.map(project => ({ ...project, type: 'Plotting' })),
  //         ...duplexes.map(project => ({ ...project, type: 'Duplex' })),
  //         ...triplexes.map(project => ({ ...project, type: 'Triplex' })),
  //         ...(await operationApi.getCustomProjects()).data.data.map(project => ({ ...project, type: 'Custom' })),
  //       ];
