...
//     { source: "Aggregates", code: "INF-1", description: "Crushed stone supply", amount: 150000, status: "approved" },
//     { source: "Sand", code: "INF-2", description: "River sand delivered", amount: 100000, status: "pending" },
//     { source: "Cement", code: "INF-3", description: "50kg bags - initial stock", amount: 250000, status: "approved" },
//     { source: "Bricks", code: "INF-4", description: "Red bricks - batch 1", amount: 180000, status: "pending" },
//     { source: "Granite", code: "INF-5", description: "Granite slabs - flooring", amount: 200000, status: "approved" },
//   ]);
...
//         text: 'Please enter Material Source and Amount!',
...
//     setFormData({ source: "", code: "", description: "", amount: "" });
...
//       text: `You are about to approve ${selectedRows.length} material entr${selectedRows.length === 1 ? 'y' : 'ies'}`,
//       icon: 'question',
...
//         setData(prev => prev.map(item => 
//           selectedRows.includes(item.code) ? { ...item, status: "approved" } : item
//         ));
//         setSelectedRows([]);
//         setSelectAll(false);
...
//           icon: 'success',
//           title: 'Approved!',
//           text: `${selectedRows.length} entr${selectedRows.length === 1 ? 'y has' : 'ies have'} been approved.`,
//           confirmButtonColor: '#16a34a',
//           timer: 2000,
//           showConfirmButton: false
//         });
...
//       text: `You are about to delete ${selectedRows.length} material entr${selectedRows.length === 1 ? 'y' : 'ies'}. This action cannot be undone!`,
//       icon: 'warning',
//       showCancelButton: true,
...
//     }).then((result) => {
//       if (result.isConfirmed) {
//         setData(prev => prev.filter(item => !selectedRows.includes(item.code)));
//         setSelectedRows([]);
//         setSelectAll(false);
...
//           icon: 'success',
//           title: 'Deleted!',
//           text: `${selectedRows.length} entr${selectedRows.length === 1 ? 'y has' : 'ies have'} been deleted.`,
//           confirmButtonColor: '#16a34a',
//           timer: 2000,
//           showConfirmButton: false
//         });
...
//   const handleSubmit = () => {
//     const pendingEntries = data.filter(item => item.status === "pending");
    
//     if (pendingEntries.length > 0) {
//       Swal.fire({
//         title: 'Pending Approvals',
//         text: `You have ${pendingEntries.length} pending entr${pendingEntries.length === 1 ? 'y' : 'ies'} that need approval. Do you want to submit anyway?`,
//         icon: 'question',
//         showCancelButton: true,
//         confirmButtonColor: '#16a34a',
//         cancelButtonColor: '#d33',
...
//   const submitData = () => {
//     Swal.fire({
//       title: 'Submit Inflow Data?',
//       text: 'This will finalize all material entries.',
//       icon: 'question',
//       showCancelButton: true,
//       confirmButtonColor: '#16a34a',
//       cancelButtonColor: '#d33',
...
//           icon: 'success',
//           title: 'Submitted!',
//           text: 'Material inflow data has been submitted successfully.',
//           confirmButtonColor: '#16a34a',
//         });
//       }
//     });
...
//             {selectedRows.length} entr{selectedRows.length === 1 ? 'y' : 'ies'} selected
//           </span>
