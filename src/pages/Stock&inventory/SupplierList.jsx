  ...
  const deleteSupplier = async () => {
    ...
    try {
      ...
      const response = await api.delete(
        `/api/tenant/supplier/${supplierToDelete.id}`,
      );
  ...
  const updateSupplier = async () => {
    ...
    try {
      ...
      const response = await api.put(
        `/api/tenant/supplier/${selectedSupplier.id}`,
        editFormData,
      );
                        ...
                        <tr>
                          <td colSpan="7" className="px-4 py-12 text-center">
                            <div className="flex flex-col items-center justify-center text-gray-500">
                              ...
                              <p className="text-sm">
                                No suppliers available or matching your search
                                criteria
                              </p>
                            </div>
                          </td>
            ...
            <div>
              ...
              {selectedSupplier.alternate_phone && (
                <p className="text-xs text-gray-500">
                  Alt: {selectedSupplier.alternate_phone}
                </p>
              )}
            </div>
            <div>
        ...
        <div className="p-6">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500">
              Supplier ledger transactions will be available in the next update
            </p>
          </div>
        </div>
      </div>
