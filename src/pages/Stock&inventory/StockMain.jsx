...
const StockMain = () => {
  ...
  const tabs = [
    { id: "stockEntry", label: "Stock Entry", icon: "📝" },
    { id: "stockList", label: "Stock List", icon: "📋" },
    { id: "stockTransferEntry", label: "Stock Transfer Entry", icon: "�" },
    { id: "stockTransferAccept", label: "Stock Transfer Accept", icon: "✅" },
  ];
