...
const PurchaseLedger = () => {
  ...
  const handleDownloadCSV = () => {
    ...
    link.setAttribute(
      "download",
      `purchase_ledger_${fromDate || "all"}_${toDate || "all"}.csv`,
    );
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-md p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Track all purchase transactions and balances
            </p>
          </div>
          ...
          <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p
                  className={`text-xl font-bold ${totalBalance >= 0 ? "text-gray-800" : "text-red-600"}`}
                >
                    ...
                    <div className="flex flex-col items-center justify-center text-gray-400">
                      ...
                      <div className="text-lg font-medium text-gray-500 mb-1">
                        {ledgerEntries.length === 0
                          ? "No purchase ledger entries found"
        ...
        {currentEntries.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6 pt-4 border-t border-gray-200">
            ...
            <div
              className={`p-4 rounded-lg ${totalBalance >= 0 ? "bg-green-50" : "bg-red-50"}`}
            >
              <h3
                className={`text-sm font-medium ${totalBalance >= 0 ? "text-green-800" : "text-red-800"}`}
              >
                Net Balance
              </h3>
              <p
                className={`text-2xl font-bold ${totalBalance >= 0 ? "text-green-900" : "text-red-900"}`}
              >
                {formatCurrency(totalBalance)}
              </p>
            </div>
