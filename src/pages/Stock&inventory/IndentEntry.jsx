...
const IndentEntry = () => {
  ...
  const handleSupplierSelect = (e) => {
    ...
    if (supplierId) {
      const selectedSupplier = masterData.suppliers.find(s => s.id === parseInt(supplierId));
      if (selectedSupplier) {
        setSupplier({
  ...
  const saveIndent = async () => {
    ...
    try {
      ...
      if (error.response?.data?.errors) {
        ...
        toast.error(error.message || 'Failed to save indent. Please check all fields and try again.', {
          autoClose: 5000,
        });
      }
    } finally {
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="mb-6">
                ...
                <p className="text-xs text-gray-500 mt-1">Select a supplier to auto-fill details, or enter manually below</p>
              </div>
              ...
              {masterDataLoading ? (
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        {safeArray(masterData.filteredProducts).map(product => (
                      ...
                      {productForm.category && safeArray(masterData.filteredProducts).length === 0 && (
                        <p className="text-xs text-red-500 mt-1">No products available in this category</p>
                      )}
                    </div>
                  ...
                  <button
                    ...
                    disabled={loading || !productForm.product || !productForm.quantity}
            ...
            {productList.length > 0 && (
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                  <h3 className="text-lg font-semibold text-gray-800">Product List ({productList.length} items)</h3>
                </div>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {productList.map((product, index) => (
                        <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-4 py-3 text-sm text-gray-600">{product.units}</td>
            ...
            <div className="flex justify-end space-x-4 pt-6">
              ...
              <button
                onClick={saveIndent}
                disabled={loading || productList.length === 0 || (!selectedSupplierId && !supplier.name)}
