...
const Login = () => {
  ...
  const theme = isEmployeeLogin
    ? {
      ...
      logoBg: "bg-linear-to-br from-green-600 to-emerald-500 shadow-green-500/10",
      ...
      <div className="login-page-wrapper bg-[#eaeef3] min-h-screen w-full flex items-center justify-center p-6 relative overflow-hidden font-body">
        ...
        >
          <div className="relative mx-auto w-16 h-16 mb-6 flex items-center justify-center rounded-lg bg-slate-50 border border-slate-100">
            <ShieldCheck className={`h-8 w-8 ${theme.textPrimary} stroke-[1.8]`} />
            <div className={`absolute -inset-2 rounded-2xl border ${theme.pingBorder} animate-ping opacity-60 [animation-duration:2.5s]`}></div>
          </div>
          ...
          <div className="flex items-center justify-center gap-2.5 py-3 rounded-lg bg-slate-50 border border-slate-100/60 max-w-60 mx-auto">
            <Loader2 className={`h-4 w-4 animate-spin ${theme.textPrimary} stroke-[2.5]`} />
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className={`text-[8px] font-bold tracking-[0.2em] uppercase leading-none ${theme.textPrimary}`}>
            ...
            >
              ...
              <div className="absolute top-3.5 left-4 right-4 flex items-center justify-between">
                ...
                <div className="relative h-6 w-6 flex items-center justify-center">
                  ...
                  <span className={`font-mono text-[6px] font-black ${theme.plate2DialText}`}>
                    82
                  </span>
                </div>
              </div>
              ...
              <div className="absolute top-12 left-4 right-4 flex items-center gap-1 opacity-60">
                ...
                <div className={`w-1 h-1 rounded-full border ${theme.plate2SplineNode}`} />
          ...
          <div className="my-auto max-w-97.5 w-full mx-auto">
            ...
            <div className={`mb-4 inline-flex h-9 w-9 items-center justify-center rounded-md border ${theme.bgLight} ${theme.borderLight}`}>
              {isEmployeeLogin ? (
                ...
                <Lock className={`h-4.5 w-4.5 ${theme.textPrimary} stroke-[1.8]`} />
              )}
            </div>
