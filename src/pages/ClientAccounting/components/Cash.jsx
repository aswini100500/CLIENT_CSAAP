...
const CashActivities = () => {
  ...
  const handleTransactionSubmit = async (e) => {
    e.preventDefault();
    alert(
      "In this demo, manual cash entries should be done via Payment or Receipt Vouchers for full accounting integrity.",
    );
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-500">
              Manage your cash-in-hand and petty cash
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <h3 className="text-2xl font-bold text-gray-900">
            {formatCurrency(
              cashAccounts.reduce((sum, acc) => sum + acc.currentBalance, 0),
            )}
          </h3>
              ...
              {cashAccounts.length === 0 ? (
                <div className="p-8 text-center">
                  ...
                  <p className="text-xs text-gray-400 mt-2">
                    Create a ledger under 'Cash-in-hand' group to see it here.
                  </p>
                </div>
              ) : (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <div
                          className={`p-2 rounded-lg ${selectedAccount?.id === account.id ? "bg-blue-100 text-blue-600" : "bg-gray-100 text-gray-500"}`}
                        >
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 uppercase tracking-wider">
                            {account.underGroup || account.under}
                          </p>
                        </div>
                      </div>
        ...
        <div className="lg:col-span-2">
          {selectedAccount ? (
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm overflow-hidden relative">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 relative z-10">
                  ...
                  <button
                    onClick={() =>
                      alert(
                        "Please use Payment or Receipt Vouchers to add transactions.",
                      )
                    }
              ...
              {loading ? (
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center shadow-sm">
                  ...
                  <p className="text-gray-500 max-w-xs mx-auto">
                    There are no cash transactions recorded for this ledger yet.
                  </p>
                </div>
              ) : (
                          ...
                          {dayGroup.transactions.map((transaction) => (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-4">
                                  <div
                                    className={`p-3 rounded-xl ${getTransactionColor(transaction.transactionType)} shadow-sm`}
                                  >
                                    {getTransactionIcon(
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center shadow-sm">
              ...
              <p className="text-gray-500 max-w-xs mx-auto">
                Choose a cash ledger from the left panel to view its transaction
                history.
              </p>
            </div>
          )}
            ...
            <div className="p-8">
              ...
              <div className="p-6 bg-blue-50 rounded-2xl mb-8">
                <p className="text-blue-700 text-sm font-medium leading-relaxed">
                  To maintain proper accounting standards, please record cash
                  transactions using
                  <span className="font-bold underline ml-1 cursor-pointer">
                    Payment Vouchers
                  </span>{" "}
                  (for outgoing cash) or
                  <span className="font-bold underline ml-1 cursor-pointer">
                    Receipt Vouchers
                  </span>{" "}
                  (for incoming cash).
