...
const PaymentVoucherDetailModal = ({ voucher, onClose, onEdit, onDownload, ledgerMap = {} }) => {
    ...
    const paymentMode = voucher.accountTypeName || ledgerMap[voucher.accountType] || voucher.accountType || "—";
                ...
                <div className="px-6 py-5 border-b border-gray-100">
                    <div className="flex items-start justify-between gap-4 mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 id="pv-modal-title" className="text-base font-semibold text-gray-900 leading-tight">
                                    Payment voucher details
                                </h2>
                                <p className="text-xs text-gray-400 mt-0.5">Outgoing payment record</p>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <div className="flex flex-wrap gap-2">
                        <span className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-full bg-gray-50 border border-gray-100 text-gray-600">
                            ...
                            Voucher no. <span className="font-semibold text-gray-800">{voucher.voucherNo || voucher.id}</span>
                        </span>
                        <span className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-full bg-gray-50 border border-gray-100 text-gray-600">
                        ...
                        <span className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-full bg-gray-50 border border-gray-100 text-gray-600 max-w-full">
                            ...
                            <span className="font-semibold text-gray-800 truncate" title={paymentMode}>{paymentMode}</span>
                        </span>
                    </div>
                </div>
                ...
                <div className="px-6 py-5 flex flex-col gap-4">
                    ...
                    <div className="rounded-xl border border-gray-100 overflow-hidden">
                        ...
                        <div className="px-4 py-4 flex flex-col gap-4">
                            <div>
                                <p className="text-xs text-gray-500 mb-0.5">Total amount paid</p>
