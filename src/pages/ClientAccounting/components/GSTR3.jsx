            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              <div className="flex justify-between items-center py-2 bg-gray-50 p-3 rounded-lg mt-2">
                ...
                {taxLiability.totalPayable === "₹0" ? (
                  <span className="font-bold text-green-700">
                    Refund: {taxLiability.totalRefund}
                  </span>
                ) : (
                  <span className="font-bold text-red-700">
                    Payable: {taxLiability.totalPayable}
                  </span>
                )}
              </div>
            </div>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
        ...
        <ul className="space-y-2 text-yellow-700">
          <li className="flex items-start">
            ...
            <span>
              Ensure all data from GSTR-1 and GSTR-2B is reconciled before
              filing GSTR-3B
            </span>
          </li>
          <li className="flex items-start">
          ...
          <li className="flex items-start">
            <span className="mr-2">•</span>
            <span>
              Refund claims will be processed separately after return filing
            </span>
          </li>
        </ul>
      </div>
