...
const DebitNote = () => {
  ...
  const handleCreateDebitNote = async () => {
    ...
    try {
      if (isEditMode) {
        ...
        Swal.fire({
          icon: "success",
          title: "Debit Note Updated Successfully",
          timer: 1500,
          showConfirmButton: false,
        });
        navigate(listPath);
      ...
      const result = await Swal.fire({
        ...
        text: "The debit note has been saved. What would you like to do next?",
        showCancelButton: true,
  ...
  const listPath =
    role === "employee"
      ? "/employee/hr/accounting/client/debitNotesList"
      : "/accounting/client/debitNotesList";
      ...
      <div className="max-w-6xl mx-auto bg-white app-panel border border-[#e2f2e9]/80 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
        <div className="flex justify-between items-center border-b border-[#e2f2e9] pb-5 mb-8">
          <div className="flex items-center gap-3">
            <h2 className="app-title text-xl font-extrabold text-[#042f2e]">
              {isEditMode ? "Debit Note Alteration" : "Debit Note Creation"}
            </h2>
          ...
          >
            <ArrowLeft size={16} /> Back to Debit Note List
          </button>
        </div>
        ...
        <div className="bg-[#f6faf7] border border-[#cbe0d2] rounded-2xl p-6 shadow-[0_2px_8px_rgba(0,166,81,0.01)] mb-6">
          <div className="flex gap-2 border-b border-[#cbe0d2] pb-3 mb-5">
            ...
            >
              <Truck size={14} /> Receipt & Reference
            </button>
          </div>
        ...
        <div className="mt-8 flex justify-end gap-4 border-t border-[#e2f2e9] pt-6">
          ...
          >
            <Save size={16} />{" "}
            {isEditMode ? "Update Debit Note" : "Save Debit Note"}
          </button>
