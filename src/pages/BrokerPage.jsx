...
import BrokerPageDetailsModal from "./BrokerPageDetailsModal";

const fetcher = (url) =>
  client.get(url).then((res) => res.data.brokers || res.data.data);
...
const BrokerPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-10 relative overflow-hidden font-sans">
      <div
        className={`fixed top-20 right-8 z-999 transform transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] flex items-center gap-4 bg-white border border-blue-100 shadow-[0_20px_50px_rgba(0,0,0,0.1)] px-6 py-4 rounded-2xl ${showToast ? "translate-x-0 opacity-100" : "-translate-x-32 opacity-0 pointer-events-none"}`}
      >
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
          <div>
            ...
            <p className="text-slate-500 font-medium text-md">
              Manage your company's high-impact partners.
            </p>
          </div>
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <button
              ...
              className="bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded-2xl font-bold shadow-2xl shadow-green-200 transition-all active:scale-95"
            >
              + Add Brokers
            </button>
          </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
              ...
              <h3 className="text-2xl font-black text-slate-800 tracking-tight">
                {searchTerm
                  ...
                  : "The company has no brokers yet"}
              </h3>
              <button
                onClick={() =>
                  searchTerm ? setSearchTerm("") : setShowAddForm(true)
                }
                    ...
                    >
                      <td className="px-10 py-7">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <div className="font-black text-slate-900 text-md leading-tight">
                              {broker.name}
                            </div>
                      ...
                      <td className="px-10 py-7 text-right">
                        <div className="flex justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            ...
                            className="p-3 bg-white border border-slate-200 text-slate-600 hover:text-indigo-600 rounded-xl transition-all shadow-sm"
                          ...
                          <button
                            ...
                            className="p-3 bg-white border border-rose-100 text-rose-400 hover:text-rose-600 rounded-xl transition-all shadow-sm"
                            title="Delete Broker"
                          >
                            <svg
                              className="w-5 h-5"
          ...
          <div className="bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            <div className="p-10 border-b border-slate-50">
              <h2 className="text-3xl font-black text-slate-900 tracking-tighter">
                {selectedBroker ? "Update Partner" : "New Onboarding"}
              </h2>
              <p className="text-slate-400 font-medium">
                Enter broker credentials and details below.
              </p>
            </div>
            <form onSubmit={handleSubmit} className="p-10 space-y-5">
              ...
              <div className="flex justify-end gap-4 pt-8">
                ...
                <button
                  ...
                  className="bg-slate-900 text-white px-10 py-4 rounded-2xl font-black shadow-xl disabled:bg-slate-300"
                >
                  {isSubmitting
                    ? "Syncing..."
                    : selectedBroker
