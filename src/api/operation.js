...
const operationApi = {
  ...
  getProductsByCategory: (categoryId) =>
    client.get(`${API_PREFIX}/products/category/${categoryId}`),
  ...
  updateSupplier: (id, data) =>
    client.put(`${API_PREFIX}/supplier/${id}`, data),
  ...
  updateContractor: (id, data) =>
    client.put(`${API_PREFIX}/contractors/${id}`, data),
  deleteContractor: (id) => client.delete(`${API_PREFIX}/contractors/${id}`),
  searchContractors: (query) =>
    client.get(`${API_PREFIX}/contractors/search?name=${query}`),
  ...
  updateVendorManpower: (id, data) =>
    client.put(`${API_PREFIX}/vendors/${id}/manpower`, data),
  updateVendorMachines: (id, data) =>
  ...
  createEquipment: (data) =>
    client.post(`${API_PREFIX}/equipments/create`, data),
  updateEquipment: (id, data) =>
    client.put(`${API_PREFIX}/equipments/${id}`, data),
  ...
  updateOperator: (id, data) =>
    client.put(`${API_PREFIX}/operators/${id}`, data),
  ...
  getHinderingRecord: (id) =>
    client.get(`${API_PREFIX}/hindering-records/${id}`),
  createHinderingRecord: (data) =>
    client.post(`${API_PREFIX}/hindering-records/create`, data),
  updateHinderingRecord: (id, data) =>
    client.put(`${API_PREFIX}/hindering-records/${id}`, data),
  deleteHinderingRecord: (id) =>
    client.delete(`${API_PREFIX}/hindering-records/${id}`),
  updateHinderingRecordStatus: (id, status) =>
    client.patch(`${API_PREFIX}/hindering-records/${id}/status`, { status }),

  getLabourRates: () => client.get(`${API_PREFIX}/labour-rates`),
  getLabourRate: (id) => client.get(`${API_PREFIX}/labour-rates/${id}`),
  createLabourRate: (data) =>
    client.post(`${API_PREFIX}/labour-rates/save`, data),
  updateLabourRate: (id, data) =>
    client.put(`${API_PREFIX}/labour-rates/labour/${id}`, data),
  deleteLabourRate: (id) =>
    client.delete(`${API_PREFIX}/labour-rates/labour/${id}`),
  updateLabourFacility: (id, data) =>
    client.put(`${API_PREFIX}/labour-rates/facility/${id}`, data),
  deleteLabourFacility: (id) =>
    client.delete(`${API_PREFIX}/labour-rates/facility/${id}`),
  ...
  createProjectBudget: (data) =>
    client.post(`${API_PREFIX}/project-budgets/create`, data),
  updateProjectBudget: (id, data) =>
    client.put(`${API_PREFIX}/project-budgets/${id}`, data),
  deleteProjectBudget: (id) =>
    client.delete(`${API_PREFIX}/project-budgets/${id}`),

  getBillInwards: () => client.get(`${API_PREFIX}/bill-inwards`),
  getBillInward: (id) => client.get(`${API_PREFIX}/bill-inwards/${id}`),
  createBillInward: (data) =>
    client.post(`${API_PREFIX}/bill-inwards/create`, data),
  updateBillInward: (id, data) =>
    client.put(`${API_PREFIX}/bill-inwards/${id}`, data),
  deleteBillInward: (id) => client.delete(`${API_PREFIX}/bill-inwards/${id}`),

  getContractorCompliances: () =>
    client.get(`${API_PREFIX}/contractor-compliances`),
  getContractorCompliance: (id) =>
    client.get(`${API_PREFIX}/contractor-compliances/${id}`),
  createContractorCompliance: (data) =>
    client.post(`${API_PREFIX}/contractor-compliances`, data),
  updateContractorCompliance: (id, data) =>
    client.put(`${API_PREFIX}/contractor-compliances/${id}`, data),
  deleteContractorCompliance: (id) =>
    client.delete(`${API_PREFIX}/contractor-compliances/${id}`),
  createContractorComplianceItem: (complianceId, data) =>
    client.post(
      `${API_PREFIX}/contractor-compliances/${complianceId}/items`,
      data,
    ),
  updateContractorComplianceItemStatus: (complianceId, itemId, data) =>
    client.patch(
      `${API_PREFIX}/contractor-compliances/${complianceId}/items/${itemId}/status`,
      data,
    ),

  getTenderWorkOrders: () => client.get(`${API_PREFIX}/tenders/work-order/all`),
  createTenderWorkOrder: (data) =>
    client.post(`${API_PREFIX}/tenders/work-order/create`, data),
  updateTenderWorkOrder: (id, data) =>
    client.put(`${API_PREFIX}/tenders/work-order/${id}`, data),
  deleteTenderWorkOrder: (id) =>
  ...
  getIndentHistory: (params) =>
    client.get(`${API_PREFIX}/indents/history`, { params }),
  updateIndentStatus: (id, status) =>
  ...
  getProjectSetup: (id) =>
    client.get(`${API_PREFIX}/work-diary/project-setup/${id}`),
  createProjectSetup: (data) =>
    client.post(`${API_PREFIX}/work-diary/project-setup`, data),
  updateProjectSetup: (id, data) =>
    client.put(`${API_PREFIX}/work-diary/project-setup/${id}`, data),
  deleteProjectSetup: (id) =>
    client.delete(`${API_PREFIX}/work-diary/project-setup/${id}`),

  getLabourDetails: () => client.get(`${API_PREFIX}/work-diary/labour-details`),
  getLabourDetail: (id) =>
    client.get(`${API_PREFIX}/work-diary/labour-details/${id}`),
  createLabourDetails: (data) =>
    client.post(`${API_PREFIX}/work-diary/labour-details`, data),
  updateLabourDetails: (id, data) =>
    client.put(`${API_PREFIX}/work-diary/labour-details/${id}`, data),
  deleteLabourDetails: (id) =>
    client.delete(`${API_PREFIX}/work-diary/labour-details/${id}`),

  getToolsPlants: () => client.get(`${API_PREFIX}/work-diary/tools-plants`),
  getToolsPlant: (id) =>
    client.get(`${API_PREFIX}/work-diary/tools-plants/${id}`),
  createToolsPlants: (data) =>
    client.post(`${API_PREFIX}/work-diary/tools-plants`, data),
  updateToolsPlants: (id, data) =>
    client.put(`${API_PREFIX}/work-diary/tools-plants/${id}`, data),
  deleteToolsPlants: (id) =>
    client.delete(`${API_PREFIX}/work-diary/tools-plants/${id}`),

  getStagePassings: () => client.get(`${API_PREFIX}/work-diary/stage-passings`),
  getStagePassing: (id) =>
    client.get(`${API_PREFIX}/work-diary/stage-passings/${id}`),
  createStagePassing: (data) =>
    client.post(`${API_PREFIX}/work-diary/stage-passings`, data),
  updateStagePassing: (id, data) =>
    client.put(`${API_PREFIX}/work-diary/stage-passings/${id}`, data),
  deleteStagePassing: (id) =>
    client.delete(`${API_PREFIX}/work-diary/stage-passings/${id}`),

  getDailyReports: () => client.get(`${API_PREFIX}/work-diary/daily-reports`),
  getDailyReport: (id) =>
    client.get(`${API_PREFIX}/work-diary/daily-reports/${id}`),
  createDailyReport: (data) =>
    client.post(`${API_PREFIX}/work-diary/daily-reports`, data),
  updateDailyReport: (id, data) =>
    client.put(`${API_PREFIX}/work-diary/daily-reports/${id}`, data),
  deleteDailyReport: (id) =>
    client.delete(`${API_PREFIX}/work-diary/daily-reports/${id}`),

  getRawMaterials: () => client.get(`${API_PREFIX}/work-diary/raw-materials`),
  createRawMaterial: (data) =>
    client.post(`${API_PREFIX}/work-diary/raw-materials`, data),
  ...
  createBOQItem: (data) =>
    client.post(`${API_PREFIX}/document-managements`, data),
  updateBOQItem: (id, data) =>
    client.put(`${API_PREFIX}/document-managements/${id}`, data),
  deleteBOQItem: (id) =>
    client.delete(`${API_PREFIX}/document-managements/${id}`),
  updateDocument: (id, data) =>
    client.put(`${API_PREFIX}/document-managements/${id}/items`, data),
  addApproval: (id, data) =>
    client.post(`${API_PREFIX}/document-managements/${id}/approve`, data),
  uploadAttachment: (id, data) =>
    client.post(`${API_PREFIX}/document-managements/${id}/attachments`, data),
  deleteAttachment: (documentId, attachmentId) =>
    client.delete(
      `${API_PREFIX}/tenant/document-managements/${documentId}/attachments/${attachmentId}`,
    ),
};
