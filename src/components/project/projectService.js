...
const projectService = {
  ...
  getAllCustomProjects: async () => {
    const response = await axios.get(`${API_URL}/custom-projects`, {
      params: { slug: getSlug(), subdomain: getSlug() },
      headers: {
        Authorization: `Bearer ${getAuthToken()}`,
      },
  ...
  getCustomProjectById: async (id) => {
    const response = await axios.get(`${API_URL}/custom-projects/${id}`, {
      params: { slug: getSlug(), subdomain: getSlug() },
      headers: {
        Authorization: `Bearer ${getAuthToken()}`,
      },
  ...
  deleteCustomProject: async (id) => {
    const response = await axios.delete(`${API_URL}/custom-projects/${id}`, {
      params: { slug: getSlug(), subdomain: getSlug() },
      headers: {
        Authorization: `Bearer ${getAuthToken()}`,
      },
