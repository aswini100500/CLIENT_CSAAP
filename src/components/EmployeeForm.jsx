...
const EmployeeForm = () => {
  ...
  return (
    <form
      ...
      className="p-8 bg-white space-y-8 max-w-6xl mx-auto shadow-2xl border rounded-lg"
    >
      <div className="border-b pb-4">
        ...
        <p className="text-gray-500">
          Fill in all profile and login details below.
        </p>
      </div>
      ...
      <section className="space-y-4 bg-gray-50 p-6 rounded-md">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div>
            <label className="block text-sm font-medium">Post Applied</label>
            <input
              className="w-full border rounded p-2 mt-1"
              name="postApplied"
              onChange={handleInputChange}
      ...
      <section className="space-y-4">
        ...
        {education.map((edu, idx) => (
          <div
            key={idx}
            className="grid grid-cols-3 gap-4 p-2 border-l-4 border-blue-400"
          >
            <input
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-gray-100 p-4 rounded">
        <div>
          <label className="text-xs font-bold">Start Date (Prev Job)</label>
          <input
            type="date"
            name="startDate"
        ...
        <div>
          <label className="text-xs font-bold">End Date (Prev Job)</label>
          <input
            type="date"
            name="endDate"
            className="w-full p-2 border"
        ...
        <div className="col-span-2">
          <label className="text-xs font-bold">Exp. Description</label>
          <input
            name="experienceDescription"
            className="w-full p-2 border"
            onChange={handleInputChange}
            placeholder="Brief summary of roles..."
          />
        </div>
      </section>
      ...
      <div className="pt-6">
        <button
          type="submit"
          className="w-full bg-blue-600 text-white py-4 rounded-xl font-bold text-xl shadow-lg hover:bg-blue-700 transition-all active:scale-95"
        >
          REGISTER EMPLOYEE
        </button>
      </div>
